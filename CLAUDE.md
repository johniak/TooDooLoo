...
- Lewa kolumna: lista dni — tylko dni robocze (7 wstecz, 5 wprzód; weekendy pokazywane tylko, gdy mają dane), aktywny dzień z ember insetem, badge = liczba niezrobionych, kropka = są notatki; na dole ustawienia: godzina startu pracy (`<input type="time">`) i checkbox „W Docku".
...
- Eksplorator notatek: pozycja „▤ Notatki" na dole sidebara — osobny widok panelu (`view: 'day' | 'notes'` w App) z siatką wszystkich notatek, edytorem i podstronami. Link z todosa przełącza na ten widok.
