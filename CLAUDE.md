...
- Eksplorator notatek: pozycja „▤ Notatki" na dole sidebara — osobny widok panelu (`view: 'day' | 'notes' | 'settings' | 'timeline' | 'reports'` w App) z siatką wszystkich notatek, edytorem i podstronami. Link z todosa przełącza na ten widok.
